...
exports.Prisma.SiteScalarFieldEnum = makeEnum({
  ...
  commentBoxAbove: 'commentBoxAbove'
});
...
exports.PageIdentification = makeEnum({
  urlPath: 'urlPath',
  fullUrl: 'fullUrl',
...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/zionchen/Main/h/cemmont/prisma/client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
