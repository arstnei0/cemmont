<template>
	<div class="bar">
		<h1>Site info:</h1>
		<NuxtLink :to="`/setup/${id}`"
			><VBtn color="primary">Setup on your website</VBtn></NuxtLink
		>
	</div>
	<p>
	...
	<VRadioGroup v-model="info.page_identification">
		...
		<VRadio
			label="Page Title in HTML <title>"
			value="pageTitleHtmlTag"
		></VRadio>
		<VRadio
			label="Page Title in the meta `og:title`"
	...
	<VSwitch
		...
		v-model="info.reactions_enabled"
	></VSwitch>
	<VSwitch
		label="Place the comment box above the comments"
		v-model="info.comment_box_above"
	></VSwitch>
</template>
